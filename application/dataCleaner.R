...
final4Data <- readRDS(file="./data/en_US/final4Data.RData")
final3Data <- readRDS(file="./data/en_US/final3Data.RData")
final2Data <- readRDS(file="./data/en_US/final2Data.RData")
...
nextWordPrediction <- function(wordCount,textInput){
  ...
  print(wordPrediction, row.names = FALSE)
}
